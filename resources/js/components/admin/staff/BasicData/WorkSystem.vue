            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p border-bottom-0"> نوع نظام الدوام</th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row row-sm">
                    ...
                    <div class="col-md-3">
                      <label for="status"> نوع نظام الدوام</label>
                    ...
                    <div class="col-md-3">
                      ...
                      <select @change="get_period_tim()" style="background-color:beige" v-model="period_type_selected"  class="form-control " required>
                        <option v-for="pp in periods" v-bind:value="pp.id">
                          {{ pp.name }}
                        </option>
...
export default {
  ...
  methods: {
    ...
    get_period_tim(){
      ...
      this.axios
        .post(`/get_period_time/${this.period_type_selected}`)
        .then((responce) => {

          console.log('persssssvvvvsssiods', responce.data.period_times);
