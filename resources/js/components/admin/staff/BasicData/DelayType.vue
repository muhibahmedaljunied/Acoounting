    ...
    <div class="col-xl-12">
      <div class="card">
        ...
        <div class="card-body" id="printme">
              ...
              <tbody v-if="delay_types && delay_types.length > 0">
                <tr v-for="(delay_type, index) in delay_types" :key="index">
                  ...
                  <td>
                    ...
                    <button type="button" @click="delete_delay_type(delay_type.id)" class="btn btn-danger">
          ...
          <pagination align="center" :data="delay_type" @pagination-change-page="list"></pagination>
        </div>
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          aria-hidden="true" style="display: none" id="addDT">
