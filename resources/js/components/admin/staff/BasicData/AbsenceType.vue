    ...
    <div class="col-xl-12">
      <div class="card">
        ...
        <div class="card-body" id="printme">
          ...
          <pagination align="center" :data="absence_type" @pagination-change-page="list"></pagination>
        </div>
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          aria-hidden="true" style="display: none" id="addat">
          <div class="modal-dialog modal-lg" style="width: 100%">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="col-md-8">
                  <h4 class="modal-title" id="myLargeModalLabel"> انواع الغياب</h4>
                </div>
                <div class="col-md-4">
                  <div class="col-sm-12">
