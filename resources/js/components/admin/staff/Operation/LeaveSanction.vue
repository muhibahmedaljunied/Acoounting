<template>
  ...
  <div class="row row-sm">
        ...
        <table class="table table-bordered text-center">
          ...
          <tbody v-if="value_list && value_list.data.length > 0">
            <tr v-for="(leave_sanction, index) in value_list.data" :key="index">
              ...
              <td>{{ leave_sanction.sanctions }}</td>
              <td>
                ...
                <a class="tn btn-info btn-sm waves-effect btn-agregar" data-target="#updateSLA" data-toggle="modal" id="agregar_productos"
           >
    ...
    <div class="modal fade" id="addSLA" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form method="post">
                  ...
                  <div class="card">
                    <div class="card-header pb-0">
                      <div class="d-flex justify-content-between">
                        <h4 class="modal-title" id="myLargeModalLabel"> جزاءات الانصراف المبكر</h4>
                        ...
                        <table class="table table-bordered text-right m-t-30" style="width: 100%; font-size: x-small">
                          ...
                          <tbody>
                            <tr v-for="index in count" :key="index">
                              ...
                              <td>
                                <select v-model="leaveselected[index]" name="type" id="type" class="form-control "
                                  required>
    ...
    <div class="modal fade" id="updateSLA" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form method="post">
        <div class="modal-dialog modal-fullscreen">
          <div class="modal-content">
            <div class="modal-header">
