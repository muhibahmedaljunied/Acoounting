                ...
                <table style="width: 100% ; outline:double;">
                    ...
                    <tr>
                      ...
                      <td
                        ...
                        style="text-align: center; line-height: 1px"
                      >
                        <h2>رقم السند :{{ return_supplys[0].supply_id }}</h2>
                        <br />

                        <h2>تاريخ السند :{{ return_supplys[0].supply_date }}</h2>
                        <br />

                        <h2>
                          اسم المورد :  {{ return_supplys[0].name }}
                          {{ return_supplys[0].last_name }}
...
export default {
  ...
  mounted() {
    ...
    this.axios.post(uri).then((response) => {
      ...
      this.return_supplys = response.data.return_supplys;
