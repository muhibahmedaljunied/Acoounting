...
class CreateReturnPurchaseDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('return_purchase_details', function (Blueprint $table) {
            ...
            $table->unsignedInteger('purchase_return_id')->unsigned()->nullable();
            $table->foreign('purchase_return_id')->references('id')->on('return_purchases');
 

            $table->integer('store_product_id')->unsigned()->nullable();
